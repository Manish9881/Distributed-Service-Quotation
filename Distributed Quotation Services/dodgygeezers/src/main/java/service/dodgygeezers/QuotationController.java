...
public class QuotationController implements CommandLineRunner {
    ...
    public void run(String... args) {
        System.out.println("Starting Quotation Controller in Dodgygeezers");
        registerService();
    }

    private void registerService() {
        RestTemplate restTemplate = new RestTemplate();
        String serviceUrl = "http://dodgygeezers:" + port + "/quotations";
        System.out.println("Dodgygeezers::Attempting to register service with broker at URL: " + BROKER_URL);
        System.out.println("Dodgygeezers::Service URL being registered: " + serviceUrl);
        ...
        try {
            ...
            System.out.println("Dodgygeezers::Successfully registered service URL with broker: " + serviceUrl);
            System.out.println("Dodgygeezers::Broker response status: " + response.getStatusCode());
        } catch (Exception e) {
